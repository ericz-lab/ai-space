...
const en = {
  ...
  "settings.countServices": "{n} services",
  "settings.countBackups": "{n} backups",
  "settings.countPeers": "{n} peers",
...
const zh: Record<Key, string> = {
  ...
  "settings.countServices": "{n} 个服务",
  "settings.countBackups": "{n} 个备份",
  "settings.countPeers": "{n} 个对等节点",
  "settings.peers": "对等节点",

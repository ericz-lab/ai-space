...
const en = {
  ...
  "services.bySpace": "run by ai-space",
  "services.byOperator": "run by the operator's unit",
  "services.unitProblem": "unit problem",
  "services.start": "Start",
  "services.stop": "Stop until the next sync",
...
const zh: Record<Key, string> = {
  ...
  "services.bySpace": "由 ai-space 托管",
  "services.byOperator": "由运维自装的 unit 运行",
  "services.unitProblem": "unit 异常",
  "services.start": "启动",
  "services.stop": "停止（下次同步会再启动）",
  "services.restart": "重启",
  "settings.backups": "备份",

...
const en = {
  ...
  "settings.modelEnvironment": "Environment defaults",
  "settings.defaultModelHelp": "Shared by app requests (including ai-todo, ai-calendar and ai-notes) and new Base chats. Explicit model choices and existing Base conversations keep their model.",
  "settings.modelEffective": "Apps: {apps} · Base: {base}",
  ...
  "chat.runtimeModelTitle": "Runtime and model tier (full context)",
  ...
  "usage.tokens": "tokens",
  "usage.cost": "cost",
  "usage.costNote": "Costs include GPT estimates at standard API rates, not subscription charges. Unknown costs are excluded from totals.",
...
const zh: Record<Key, string> = {
  ...
  "settings.modelEnvironment": "使用环境配置",
  "settings.defaultModelHelp": "应用调用（包括 ai-todo、ai-calendar、ai-notes）和 Base 新对话共用。明确指定的模型和 Base 已有会话仍沿用原模型。",
  "settings.modelEffective": "应用：{apps} · Base：{base}",
  ...
  "chat.runtimeModelTitle": "运行时与模型级别（完整上下文）",
  ...
  "usage.tokens": "token",
  "usage.cost": "等价成本",
  "usage.costNote": "费用包含按标准 API 单价估算的 GPT 等价成本，不代表订阅扣款。未知费用不计入合计。",
  "usage.time": "模型耗时",
  "usage.byTag": "按应用与用途",
